...
print(f"{'='*60}")
print(f"  {'N bits':<8} {'N_base':<8} {'Codes':<8} {'ΔR at 50Ω':<12} {'% step':<10} {'R_unit'}")
print(f"  {'-'*60}")
for n in range(3, 9):
    ...
    pct = dr / R_NOM * 100
    r_u = 1.0 / g_l
    print(f"  {n:<8d} {n_b:<8d} {2**n:<8d} {dr:<12.3f} {pct:<10.2f} {r_u:.1f} Ω")
